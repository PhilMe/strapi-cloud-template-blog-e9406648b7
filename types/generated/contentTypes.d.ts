...
export interface ApiBlogCategoryBlogCategory
  ...
  info: {
    description: 'Kategorien fuer Blogbeitraege';
...
export interface ApiBlogPostBlogPost extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Blogbeitraege und Content-Marketing Artikel';
  ...
  attributes: {
    author: Schema.Attribute.String &
      Schema.Attribute.DefaultTo<'Cobipedia'>;
    ...
    publishedAt: Schema.Attribute.DateTime;
    relatedSets: Schema.Attribute.Relation<'manyToMany', 'api::set.set'>;
...
export interface ApiAffiliateLinkAffiliateLink
  ...
  info: {
    description: 'Shop-Preise und Links pro Set';
...
export interface ApiCategoryCategory extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Kategorien wie Schiffe, Panzer, Flugzeuge';
...
export interface ApiHistoricalContextHistoricalContext
  extends Struct.CollectionTypeSchema {
  collectionName: 'historical_contexts';
  info: {
    description: 'Historische Hintergrundinformationen';
    displayName: 'Historical Context';
    pluralName: 'historical-contexts';
    singularName: 'historical-context';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::historical-context.historical-context'
    > &
      Schema.Attribute.Private;
...
export interface ApiManufacturerManufacturer
  ...
  info: {
    description: 'Hersteller wie COBI';
...
export interface ApiSeriesSeries extends Struct.CollectionTypeSchema {
  collectionName: 'all_series';
  info: {
    description: 'Produktserien';
    displayName: 'Series';
    pluralName: 'all-series';
    singularName: 'series';
  };
  options: {
    draftAndPublish: true;
...
export interface ApiSetSet extends Struct.CollectionTypeSchema {
  collectionName: 'sets';
  info: {
    description: 'COBI Sets - Hauptentit\u00E4t';
    displayName: 'Set';
    pluralName: 'sets';
    singularName: 'set';
  };
  ...
  attributes: {
    ...
    currency: Schema.Attribute.Enumeration<['EUR', 'USD', 'PLN']> &
      Schema.Attribute.DefaultTo<'EUR'>;
    description: Schema.Attribute.Text;
    dimensionUnit: Schema.Attribute.Enumeration<['cm', 'mm', 'inches']> &
      Schema.Attribute.DefaultTo<'cm'>;
    height: Schema.Attribute.Decimal;
    historicalContext: Schema.Attribute.Relation<
      'manyToOne',
      'api::historical-context.historical-context'
    >;
    ...
    metaDescription: Schema.Attribute.Text;
    metaTitle: Schema.Attribute.String;
    minifigures: Schema.Attribute.Integer & Schema.Attribute.DefaultTo<0>;
    ...
    setNumber: Schema.Attribute.String &
      Schema.Attribute.Required &
      Schema.Attribute.Unique;
    slug: Schema.Attribute.UID<'name'>;
    status: Schema.Attribute.Enumeration<
      ['available', 'discontinued', 'announced', 'unknown']
    > &
...
export interface ApiShopShop extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Shops f\u00FCr Affiliate Links';
    displayName: 'Shop';
    pluralName: 'shops';
    singularName: 'shop';
  };
